...
/**
 * Servlet implementation class FotoPlace
 */
@WebServlet("/FotoPlace")
public class FotoPlace extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (blobKeys == null || blobKeys.isEmpty()) {
        	...
        	String username = req.getParameter("idTarget");
        	Query<Entity> query = Query.newEntityQueryBuilder().setFilter(PropertyFilter.eq("idPlace", username)).setKind("TablePlace").build();
		    ...
		    res.sendRedirect("submit-foto.jsp");
        }
	}
