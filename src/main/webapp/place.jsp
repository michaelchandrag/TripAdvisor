            ...
            <div class="container">
                <div class="row">
                    ...
                    <%
						...
						//untuk tourism placce
						KeyFactory keys = datastore.newKeyFactory().setKind("TablePlace");
					 	Key kodeResto = keys.newKey(kode);	
	        			Query<com.google.cloud.datastore.Entity> query = Query.newEntityQueryBuilder().setKind("TablePlace").setFilter(PropertyFilter.eq("idPlace",kode)).build();
				    	...
				    	String sessUser = "";
					 	if(session.getAttribute("sEmail") != null)
					 	{
					 		...
					 		KeyFactory keysWish = datastore.newKeyFactory().setKind("TableWishlistPlace");
							Query<com.google.cloud.datastore.Entity> query2 = Query.newEntityQueryBuilder()
																			.setKind("TableWishlistPlace")
																			.setFilter(PropertyFilter.eq("user",sessUser))
																			.setFilter(PropertyFilter.eq("idPlace",kode))
																			.build();
							...
							if(results2.hasNext())
							{
								...
								String idPlace = entity.getString("idPlace");
								String key = entity.getKey().getId().toString();
								if(status.equals("0"))
								{
									out.print("<input type='hidden' id='hiddenStatus' value='"+status+"'>");
									out.print("<input type='hidden' id='hiddenIdPlace' value='"+idPlace+"'>");
					...
					%>
					    ...
					    <h1 class='page-title'>Tourism Place</h1>
                            ...
                            <div class="light-slide-item">            
                                <div class="clearfix">
                                    <div class="favorite-and-print">
                                        <a id="btnWishlist" class="add-to-fav" href="#login-modal" data-toggle="modal">
                                ...
                                <div class="dealer-content">
                                    <div class="inner-wrapper">
                                        ...
                                        <div class="clear">
                                            ...
                                            <div class="col-xs-8 col-sm-8 ">
                                                <h3 class="dealer-name">
                                                    <a ><%out.println(entity.getString("nama").toString());%></a>
			...
			<li>
				...
				if (results1.hasNext()) {
					...
					while(results1.hasNext())
					{
						...
						if(!request.getParameter("ID").equalsIgnoreCase(entity1.getString("idPlace")))
						{
							//Jika Id Tidak Sama dengan Id Sekarang Maka Masuk List
							idResto.add(entity1.getString("idPlace"));
				...
				if(banyakDataResto > 0)
				{
					...
					if(banyakDataResto > 3)
					{
						...
						for(int i = 0 ; i < 3 ; i++)
						{
							String link = "place.jsp?ID="+idResto.get(randomResto.get(i));
							//Cetak Gambar Nya
					...
					else
					{
						...
						for(int i = 0 ; i < 3 ; i++)
						{
							String link = "place.jsp?ID="+idResto.get(i);
							//Cetak Gambar Nya
							//out.println("<div class='col-md-3 col-sm-3 col-xs-3 blg-thumb p0'><a href='single.html'><img src='assets/img/demo/small-property-2.jpg'></a></div>");
